namespace CatalogSystemGenerator
{
    using System;
    ...
    public class ModuleSystemGenerator : ISourceGenerator
    {
        public void Execute(GeneratorExecutionContext context)
            => context.AddSource("Generated catalog initializer",
$@"using Rein.Core.ModuleSystem;
internal static partial class Module
{{
    private static partial void InitCatalogSystem()
    {{
        ...
        private static String GetInitCallText(ClassDeclarationSyntax syntax) => $"Initializer.Init<{syntax.Identifier.Text}>();";
